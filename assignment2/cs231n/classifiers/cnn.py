...
#some of the following code comes from the website:http:www.jianshu.com/p/9c4396653324 and Standford course website, some idea comes from the multiple sources, such as stackoverflow, and learning notes of cs231n. 
...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        num_layer = H*W*num_filters/4 # the 
        self.params['W2'] = weight_scale * np.random.randn(int(num_layer), hidden_dim)
